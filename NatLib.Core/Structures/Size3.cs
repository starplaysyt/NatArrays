...
public struct Size3 : IEquatable<Size3>
{
    ...
    public Size3(float width, float height, float depth) => Value = new Vector3(width, height, depth);

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public Size3(Vector3 value) => Value = value;

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public Size3(Size2 wh, float depth) => Value = new Vector3(wh.Value, depth);
